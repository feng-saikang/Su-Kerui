    ...
    <el-card shadow="never" class="standard-margin">
      ...
      <div class="form-container-border">
        ...
        <el-row>
          ...
          <el-col
            class="form-border font-small imgbox"
            :span="18"
            style="height:100px ;overflow: hidden"
          >
          <div v-for="(item, index) in fromatImgs(backStock.imgs)"
              :key="index">
            <img
                style="
                  width: 80px;
...
import { getBackStockDetail,updateBackStock,deleteOrder} from "@/api/order";
export default {
  data() {
    return {
      backStock: [],
  ...
  created() {
    console.log(this.order_id);
    getBackStockDetail({ order_id: this.order_id }).then((data) => {
      console.log(data);
      console.log(data.data);
      this.backStock = data.data;
    });
  },
  filters: {
    foramtParam(value) {
